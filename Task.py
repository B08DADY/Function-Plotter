...
def PlotFunction():
    ...
    try:
        ...
        QMessageBox.critical(window, "Input Error", "Invalid function format,Please Try Agian with correct format like \"x^5+x...\"")
        return
...
# (e.g., in a main function or specific use cases)
